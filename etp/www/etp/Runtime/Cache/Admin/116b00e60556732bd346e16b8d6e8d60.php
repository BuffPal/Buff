...
<div class="container-fulid">
  ...
  <?php if($name): ?><li>
      <a href="<?php echo U('classify');?>">栏目列表</a> <span class="divider">/</span>
    </li><?php endif; ?>
...
<div class="container">
 ...
 <form action="<?php echo U('addClassify6');?>" method="post" class="form-horizontal col-md-12">
    <div class="form-group">
        <label for="" class="col-sm-5 control-label"><em></em></label>
        <div class="col-sm-2" style="font-size: 25px;">
            父级栏目<em>:</em>
            <?php if($name): ?><a href="<?php echo U('classify',array('id'=>$id));?>"><?php echo ($name); ?></a>
                <?php else: ?> 根元素<?php endif; ?>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-2" style="position: relative;">
            ...
            <div id="videoPosterTestBox">
                <img src="/Public/Images/test/200x300.jpg" alt="" id="videoPosterTest">
            </div>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-2">
            <textarea id="info" name="info" class="form-control text" placeholder="请保持在200位之内" style="resize: none;height: 200px;"></textarea>
        </div>
    </div>
    <div class="form-group">
        ...
        <div class="col-sm-2">
            ...
            <input type="hidden" name="faceurl">
            <input type="hidden" name="faceurl100x150">
