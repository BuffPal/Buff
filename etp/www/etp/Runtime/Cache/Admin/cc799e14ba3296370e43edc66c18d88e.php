    ...
    <div class="container-fulid">
        <table class="table table-hover table-condensed col-md-12">
            <thead>
                ...
                <th style="width: 10%">背景图</th>
                <th style="width: 10%">音乐名</th>
                <th style="width: 10%">作者</th>
                <th style="width: 5%">音乐大小</th>
            ...
            <tbody>
                <?php if($resultAll): if(is_array($resultAll)): foreach($resultAll as $key=>$v): ?><tr>
                            ...
                            <td><img src="<?php echo ($v["musicbgurl"]); ?>" width="50"></td>
                            <td><?php echo (str_replace($keyword,'<span style="color:orangered;">'.$keyword.'</span>',$v["musicname"])); ?></td>
                            ...
                            <td>
                                ...
                                <a href="<?php echo U('op',array('id'=>$v['mid']));?>">[修改]</a> |
                                <a mid='<?php echo ($v["mid"]); ?>' class="delete">[删除]</a>
                            </td>
...
<script type="text/javascript" src="/Public/Uploadify/jquery.uploadify.min.js"></script>
    <script type="text/javascript">
    var deleteMusicUrl = "<?php echo U(deleteMusic);?>"; //AJAX删除视频处理地址
    </script>
    <script type="text/javascript" src="/Public/js/Admin/M_index.js"></script>
</body>
