...
<div class="container main">
      <form action="<?php echo U('checkLogin');?>" method="post" class="form-horizontal col-md-5" name="register" id="register">
        <div class="info hidden-xs ">
          <img src="/Public/images/Index/register/google.png">
        </div>
        <div class="form-group">
          <label for="account" class="col-sm-6 control-label">账号</label>
          <div class="col-sm-6">
        ...
        <div class="checkbox pull-right col-md-6">
          <label>
            <input type="checkbox"  value="1" name="auto" > 自动登录
          </label>
        </div>

        <div class="button-group col-md-7 pull-right">
          <a href="<?php echo U('register');?>" class="button button-pill button-primary button-3d button-smail">注册</a>
          <input type="submit" class="button button-pill button-primary button-3d button-smail" value="登录">
        </div>
