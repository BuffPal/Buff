  ...
  @section('content')
    ...
    <div class="result_wrap">
        <form action="{{ url('admin/article') }}" method="post" name="article">
            {{ csrf_field() }}
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>编辑名称：</th>
                        <td>
                            <input type="text" name="editor" value="{{ session('manage')->username }}">
                        </td>
                    </tr>
                    <tr>
                        <th>简介：</th>
                        <td>
                            <textarea name="info" style="resize:none;line-height: 15px;"></textarea>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>关键词描述：</th>
                        <td>
                            <textarea name="description" style="resize:none;line-height: 15px;"></textarea>
                        </td>
                    </tr>
                    <style>
                        .pictrue{
                    ...
                    <tr>
                        ...
                        <input type="text" id="myOutputId" readonly="readonly" name="thumb"><div class="pictrue"><img src=""></div></td>
                    </tr>
