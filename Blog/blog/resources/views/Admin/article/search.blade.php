...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{ url('admin/info') }}">首页</a> &raquo; <a href="{{ url('admin/article') }}">文章列表</a> &raquo; 指定显示列表
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="{{ url('admin/article/search') }}" method="post">
            ...
            <table class="search_tab">
                <tr>
                    ...
                    <th width="70">关键字:</th>
                    <td><input type="text" name="keywords" placeholder="{{ $keyword }}"></td>
        ...
        <div class="result_wrap">
            ...
            <div class="result_content">
                <div class="short_wrap">
                    ...
                    <a href="{{ url('admin/article') }}"><i class="fa fa-recycle"></i>全部列表</a>
                </div>
            </div>
            <!--快捷导航 结束-->
        </div>
        ...
        <div class="result_wrap">
            <div class="result_content">
                <table class="list_tab">
                    ...
                    @if($article)
                        @foreach($article as $k=>$v)
                            <tr>
                                ...
                                <td>
                                    <a href="#">{!! str_replace($keyword,'<font style="color: orangered;">'.$keyword.'</font>',$v->title) !!}</a>
                                </td>
                                <td>{{ $v->count }}</td>
                                <td>{{ $v->editor }}</td>
                    ...
                    @else
                    <tr>
                        <td>查找不到有关 ' <strong style="color: orangered;">{{ $keyword }}</strong> '的数据</td>
                    </tr>
                    @endif
                </table>
                <style>
