            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        <th>关键字：</th>
                        <td>
                            <input type="text" class="lg" name="keyword">
                    ...
                    <tr>
                        <th>关键字描述：</th>
                        <td>
                            <textarea class="lg" name="description" style="resize: none;" placeholder="请保证在255位之内"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <th>排序：</th>
                        <td>
                            <input type="text" class="sm" name="order" value="1">
                        </td>
                    </tr>
